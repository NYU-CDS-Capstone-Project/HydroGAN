...
redshift_file = "standardized_no_shift_redshift0.h5"    # redshift cube to be used
    # standardized_no_shift_redshift0.h5
    # minmax_scale_01_redshift0.h5
    # minmax_scale_neg11_redshift0.h5
inverse_transform = "std_noshift"    # minmax01 / minmaxneg11 / std_noshift / std
...
if run_in_jupyter:
    ...
    get_ipython().run_line_magic('run', 'models/decoder.py')
    get_ipython().run_line_magic('run', 'models/encoder.py')
else:
